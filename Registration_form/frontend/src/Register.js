...
function Register()
{
    ...
    useEffect(() => {
        if(filled) {
            let added = {"Username": username,"Phone":phone,"Password":password,"Email":email}
           ...
           <div className="container">
                <div className="center">
                    ...
                    <form action="">
                        ...
                        <div className="txt_field">
                            <input type="text" name="text" required value={phone} onChange={(e) => setphone(e.target.value)}/>
                            <span></span>
                            <label>Phone</label>
                        </div>
                        <div className="txt_field">
